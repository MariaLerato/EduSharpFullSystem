...
const  StarredReplies =({ navigation }) =>{
                ...
                <Card containerStyle={{ borderRadius: 10,width:'98%',marginLeft:'-1%',padding:'2%' }}>
                    ...
                    <Card.FeaturedTitle style={{ padding: '1%', marginTop: '1%' }}>
                        <View style={Styles.iconContainer}>
                            <TouchableOpacity style={{ marginLeft: 300, marginBottom: 1, display: 'flex', flexDirection: 'row' }}>
    ...
    return (
        <ScrollView style={Styles.container}>
            ...
            <Icon name={"star"} type={"font-awesome"} color={'#FFBE3F'} />
                <Text style={Styles.headertext}>Starred Posts</Text>
            </View>
